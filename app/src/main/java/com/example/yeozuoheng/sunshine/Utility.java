...
public class Utility {
    ...
    public static String getPreferredLocation(Context context) {
        ...
        String location;
       //if(LocationDialog.userLocation == null){
//            location = context.getString(R.string.pref_location_default);
//        }
        //else{
            location = LocationDialog.userLocation;
        //}
    ...
    static public boolean isNetworkAvaliable(Context c){
    ...
    static public void resetLocationStatus(Context c){
        ...
        spe.putInt(c.getString(R.string.empty_forecast_list_invalid_location), SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
        spe.apply();
    }
}